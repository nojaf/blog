...
<LlmDisclaimer>
  <p>
    An LLM wrote this post. The story, the opinions and the decisions in it are
    mine. The sentences are the model's, written from my notes and a lot of me
    pushing back until it said what I actually meant. So if a phrase reads a
