        ...
        >
            ...
            <main className="py-5 container page">
                <article>
                    ...
                    <p>For all business inquiries and more heartfelt matters I recommend you <strong>email</strong> me
                        at:<br/>
                        <a href="mailto:florian@nojaf.com">florian&#64;nojaf.com
                        </a></p>
                    <h3>Updates on my work in the open</h3>
                    <h4>Twitter</h4>
                    <p>
                        I am quite the Twitter enthusiast and I frequently tweet about new developments.<br/>
                        You can follow{' '}
                    ...
                    <h4>YouTube</h4>
                    <p>Discover my <a href="https://www.youtube.com/user/nojaf/videos">YouTube channel</a> for cinematic
                        entertainment.</p>
                    <h4>Linkedin</h4>
                    <p>
                        Visit my <strong>profile</strong> on{' '}
                        <a href="https://www.linkedin.com/in/florian-verdonck">Linkedin</a>.
                    </p>
                </article>
            </main>
        </Layout>
